...
export default async function ResourcesPage() {
  ...
  return (
    <div className="bg-deep-blue text-off-white-tan">
      ...
      <section className="mx-auto grid max-w-[90rem] gap-10 px-6 pb-16 pt-36 lg:grid-cols-[0.35fr_0.65fr]">
      ...
      {showPills && (
        <div className="mx-auto flex max-w-[90rem] flex-wrap gap-3 px-6 pt-10">
      ...
      <section className="mx-auto max-w-[90rem] px-6">
        {resources.map((resource, index) => (
          <article
            ...
            className="grid min-h-[80vh] scroll-mt-24 content-center gap-8 border-b border-off-white-tan/15 py-12 sm:py-20 lg:grid-cols-[0.2fr_0.8fr]"
          >
            <p
              aria-hidden
      ...
      <section className="mx-auto grid max-w-[90rem] items-center gap-8 px-6 py-12 sm:py-20 lg:grid-cols-2">
        <p className="text-h3">
