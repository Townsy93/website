...
export const EXPECTED_REDIRECTS: readonly (readonly [string, string])[] = [
  ...
  ["/blog/hubspot-updates-whats-new", "/insights/hubspot-updates-whats-new"],
  ...
  ["/blog/top-hubspot-features-from-inbound-2025", "/insights/top-hubspot-features-from-inbound-2025"],
