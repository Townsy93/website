  ...
  return (
    <>
      ...
      <section className="bg-off-white-tan">
        <div className="mx-auto grid max-w-[90rem] gap-16 px-6 pb-14 sm:pb-24 sm:px-12 lg:grid-cols-[1fr_400px] lg:items-start">
          <div className="pt-14">
            <Link
              href="/events"
      ...
      {others.length > 0 && (
        <section className="border-t border-[#DCDACB] bg-off-white-tan">
          <div className="mx-auto max-w-[90rem] px-6 pb-14 sm:pb-24 pt-20 sm:px-12">
