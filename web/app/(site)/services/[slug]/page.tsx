...
export async function generateStaticParams() {
  ...
  // revops-retainers has a bespoke static route, which Next prefers over
  // this template — no point prerendering an unreachable copy here.
  return slugs
    .filter((slug) => slug !== "revops-retainers")
    .map((slug) => ({ slug }));
}
